...
<body>
    ...
    <!-- David
        ...
        - login has <div class="log" id="log"><p class="log" id ="greet">
    -->
    <div class="image-block">
        <div id="icon-image-border">
            <img id="user-icon-image" src="src/img/svg/user-icon.svg" alt="User Icon">
        </div>
    </div>
    <div class="form-container">
        <form class="login-form" action="index.html" method="post">
            ...
            <input type="submit" name="log-in-submit" value="OK">
        </form>
    </div>

    <header>
        <img id="recycle-image" src="src/img/svg/recycling-logo.svg" alt="Recycle Logo">
        <span>Recycling</span>
    </header>
    ...
    <ul class="flex-container">
        <li class="flex-item">
            ...
            <div class="add-info-container add-paper-info">
                ...
                <form class="input-form" action="">
                    ...
                    <input id="paper-input" class="input-measurement-area" type="number" name="paper-input">
        ...
        <li class="flex-item">
            ...
            <!-- Widget 10 - Unkown -->
            <li class="flex-item">
                <div class=" widget-container recordput"></div>
            </li>
        ...
        <!-- Widget 12 - Unkown -->
        <li class="flex-item">
            <div class="widget-9 widget-container">
                <div id="graphput">
                    <form id="yearsel">
                        <select id="yearsal" name="year"></select>
                    </form>
